...
execute as @a unless score @s sleep_time matches 99.. run scoreboard players add SkipNight sleep_time 1
execute as @a at @s if block ~ ~ ~ #beds[occupied=true] if score SkipNight sleep_time matches 0 run function siscu:world/day_features/day_set_morning
