...
loot replace entity @e[tag=new_trade,limit=1,sort=nearest] weapon loot siscu:gameplay/trading/cartographer_ancient_city_price
loot replace entity @e[tag=new_trade,limit=1,sort=nearest] armor.head loot siscu:gameplay/trading/cartographer_ancient_city_map
