...
item modify entity @s armor.head siscu:durability/rewrite_data
execute if score siscu.damage siscu.test > siscu.durability siscu.test run item replace entity @s armor.head with air
