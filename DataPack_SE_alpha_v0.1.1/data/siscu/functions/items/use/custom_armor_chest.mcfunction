...
item modify entity @s armor.chest siscu:durability/rewrite_data
execute if score siscu.damage siscu.test > siscu.durability siscu.test run item replace entity @s armor.chest with air
