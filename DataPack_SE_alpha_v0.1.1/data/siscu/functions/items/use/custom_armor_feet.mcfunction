...
item modify entity @s armor.feet siscu:durability/rewrite_data
execute if score siscu.damage siscu.test > siscu.durability siscu.test run item replace entity @s armor.feet with air
