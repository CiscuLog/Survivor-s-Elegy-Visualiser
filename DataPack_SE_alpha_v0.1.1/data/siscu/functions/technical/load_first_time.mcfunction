...
## daytime variables
scoreboard players set daytime_speed siscu.day 3
scoreboard players set sleep_module_on siscu.day 1
...
scoreboard players set zombie_timer_limit siscu.integer 20
## entities
